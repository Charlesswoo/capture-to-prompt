...
struct ClaudeCLIAnalyzer {
    ...
    static func prompt(imageFileName: String) -> String {
        ...
        prompt_en, prompt_ko, prompt_ja (image-generation prompts), \
        key_features (array of exactly 3 short english strings), prompt_short (one short english sentence), and breakdown (object with keys: subject, \
